...
<template>
  <footer class="mb-2 opacity-70 text-sm flex justify-center gap-3 font-sans">
    联系我:
    <a href="https://github.com/heycn" target="_blank" rel="noopener noreferrer" class="flex gap-1 items-center">
      <Github theme="outline" size="18" />
      <span>heycn</span>
    </a>
    <a href="mailto:heycn@foxmail.com" title="go to my github!" target="_blank" class="flex gap-1 items-center">
